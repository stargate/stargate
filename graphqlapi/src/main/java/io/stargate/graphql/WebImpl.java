...
public class WebImpl {
    ...
    public void start() throws Exception {
        ...
        ServletHolder servletHolder = new ServletHolder(new CustomGraphQLServlet(true, persistence, authenticationService));
        context.addServlet(servletHolder, "/graphql/*");
        ServletHolder schema = new ServletHolder(new SchemaGraphQLServlet(persistence, authenticationService));
