...
public class RowDecoratorImpl extends AbstractRowDecorator {
  ...
  private DecoratedKey decoratedKeyFromRawKeyValues(Object[] pkValues) {
    ...
    return metadata.partitioner.decorateKey(serializedKey);
  }

  @Override
  protected ComparableKey<?> decoratePrimaryKey(Object... pkValues) {
    DecoratedKey decoratedKey = decoratedKeyFromRawKeyValues(pkValues);
