...
// Cassandra {4.0.10} {BufferPools} to use {TransportDescriptor} instead of {DatabaseDescriptor}
...
public class BufferPools {
  ...
  /**
   * Used by chunk cache to store decompressed data and buffers may be held by chunk cache for
   * arbitrary period.
   */
