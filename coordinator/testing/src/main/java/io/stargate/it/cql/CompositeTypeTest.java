...
public abstract class CompositeTypeTest extends BaseIntegrationTest {
  @BeforeEach
  ...
  public static class WithV4ProtocolVersionTest extends CompositeTypeTest {}

  @WithProtocolVersion("V5")
  public static class WithV5ProtocolVersionTest extends CompositeTypeTest {}
}
