...
import static io.stargate.db.cassandra.DseNextPersistenceActivator.makeConfig;
 ...
 */
class DseNextPersistenceIT extends PersistenceTest {

  private static DseNextPersistence persistence;
  private static File baseDir;

  @BeforeAll
  public static void createPersistence(ClusterConnectionInfo backend) throws IOException {
    baseDir = Files.createTempDirectory("stargate-dse-next-test").toFile();
    ...
    ClassLoader classLoader = DseNextPersistenceIT.class.getClassLoader();
    ...
    persistence = new DseNextPersistence();
