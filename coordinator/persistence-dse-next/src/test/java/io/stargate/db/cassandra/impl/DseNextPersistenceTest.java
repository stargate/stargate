...
/**
 * Unit tests for {@link DseNextPersistence}. See also integration tests: {@link
 * DseNextPersistenceIT}.
 */
class DseNextPersistenceTest {
  ...
  private static final DseNextPersistence persistence = new DseNextPersistence();
