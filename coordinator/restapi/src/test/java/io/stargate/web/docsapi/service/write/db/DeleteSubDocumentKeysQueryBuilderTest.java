...
class DeleteSubDocumentKeysQueryBuilderTest extends AbstractDataStoreTest {
  ...
  class BuildQuery {
    ...
    public void happyPath() {
      ...
      DeleteSubDocumentKeysQueryBuilder queryBuilder =
          new DeleteSubDocumentKeysQueryBuilder(subDocumentPath, keys, MAX_DEPTH);
  ...
  class Bind {
    ...
    public void happyPath() {
      ...
      withQuery(
              ...
              "DELETE FROM %s USING TIMESTAMP ? WHERE key = ? AND p0 = ? AND p1 = ? AND p2 IN ?",
              new Object[] {timestamp, documentId, "one", "two", keys})
          .returningNothing();
