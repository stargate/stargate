...
The current Cassandra version this module depends on is `6.8.64`.
...
* `6.8.55` -> `6.8.59` [stargate/stargate#3140](https://github.com/stargate/stargate/pull/3140)
* `6.8.61` -> `6.8.62` [stargate/stargate#3177](https://github.com/stargate/stargate/pull/3177)
* `6.8.62` -> `6.8.63` [stargate/stargate#3217](https://github.com/stargate/stargate/pull/3217)
