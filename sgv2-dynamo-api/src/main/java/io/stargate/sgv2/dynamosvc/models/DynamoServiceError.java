...
public final class DynamoServiceError {
  private String description;
  private int code;
  private String internalTxId;

  public DynamoServiceError() {
    super();
  }

  public DynamoServiceError(String description) {
    this.description = description;
  }

  public DynamoServiceError(String description, int code) {
    this.description = description;
    this.code = code;
  }

  /** A human-readable description of the error state */
  public DynamoServiceError description(String description) {
    this.description = description;
    return this;
  }
  ...
  public DynamoServiceError code(int code) {
    this.code = code;
    return this;
  }
  ...
  public DynamoServiceError internalTxId(String internalTxId) {
  ...
  public boolean equals(Object o) {
    ...
    DynamoServiceError DynamoServiceError = (DynamoServiceError) o;
    return Objects.equals(description, DynamoServiceError.description)
        && Objects.equals(code, DynamoServiceError.code)
        && Objects.equals(internalTxId, DynamoServiceError.internalTxId);
  }
