...
This extension is designed to integrate with Stargate. It uses the link:https://www.osgi.org/[OSGi] framework for registering the extension within the Stargate.
