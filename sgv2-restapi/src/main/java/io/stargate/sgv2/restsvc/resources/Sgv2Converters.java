...
public class Sgv2Converters {
  ...
  //   *
  //   * <p>Note that passing column values directly to the object mapper presents a number of
  // issues:
  //   *
  //   * <ul>
  ...
  //        // Large numbers can cause JSON interoperability issues, for example Javascript only
  // handles
  ...
  //              entry ->
  //                  ImmutableMap.of(
  //                      "key", toJsonValue(entry.getKey()), "value",
  ...
  //    }
  //
  //    // This covers null, booleans, strings, the remaining number types, blobs (which Jackson
  // already
  //    // converts to base64 natively), and time types (which are handled by registering
  // JavaTimeModule
  ...
  //            String.format("Invalid %s value '%s': expected a string", type.rawType(),
  // jsonValue));
  //      case Boolean:
  ...
  //        } else {
  //          throw new IllegalArgumentException(
  //              String.format("Invalid Float value '%s': expected a number or a string",
  // jsonValue));
  //        }
  //      case Double:
  //        if (jsonValue instanceof Number) {
  ...
  //        } else {
  //          throw new IllegalArgumentException(
  //              String.format("Invalid Double value '%s': expected a number or a string",
  // jsonValue));
  //        }
  //      case Decimal:
  ...
  //        } else {
  //          throw new IllegalArgumentException(
  //              String.format("Invalid Date value '%s': expected an integer or a string",
  // jsonValue));
  //        }
  //      case Time:
  //        if (jsonValue instanceof Integer || jsonValue instanceof Long) {
  ...
  //        } else {
  //          throw new IllegalArgumentException(
  //              String.format("Invalid Time value '%s': expected an integer or a string",
  // jsonValue));
  //        }
  //      case Timestamp:
  //        if (jsonValue instanceof Integer || jsonValue instanceof Long) {
  ...
  //          throw new IllegalArgumentException(
  //              String.format(
  //                  "Invalid Map value '%s': expected a JSON array of key/value objects, or a
  // string",
  //                  jsonValue));
  //        }
  //      case Tuple:
  ...
  //    throw new IllegalArgumentException(
  //        String.format(
  //            "Invalid %s value '%s': expected an integer or a string", type.rawType(),
  // jsonValue));
  //  }
  //
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "%s (at index %d of %s '%s')", e.getMessage(), index, type.rawType(),
  // jsonValues));
  //      }
  //      index += 1;
  //    }
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid Map value '%s': inner elements must be objects with two fields 'key'
  // and 'value'",
  //                jsonEntries));
  //      }
  //      @SuppressWarnings("unchecked")
  ...
  //      } catch (Exception e) {
  //        throw new IllegalArgumentException(
  //            String.format("%s (key at index %d of Map '%s')", e.getMessage(), index,
  // jsonEntries));
  //      }
  //      try {
  ...
  //      try {
  //        udtValue = udtValue.set(fieldId, toCqlValue(fieldType, jsonFieldValue),
  // fieldType.codec());
  //      } catch (Exception e) {
  //        throw new IllegalArgumentException(
  ...
  //   *
  //   * <p>This method exists separately from {@link #toCqlValue(Column.ColumnType, Object)} for
  // the v1
  ...
  //      // The exception's message doesn't really add information in any of those cases, use a
  // generic
  //      // description:
  //      throw new IllegalArgumentException(
  ...
  //    throw new IllegalArgumentException(
  //        String.format(
  //            "Invalid %s value '%s': missing closing '%s'", type.rawType(), value,
  // closingBrace));
  //  }
  //
  ...
  //      if (n < 0) {
  //        throw new IllegalArgumentException(
  //            String.format("Invalid map value '%s': invalid CQL value at character %d", value,
  // idx));
  //      }
  //
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid map value '%s': at character %d expecting ':' but got EOF", value,
  // idx));
  //      }
  //      if (value.charAt(idx) != ':') {
  //        throw new IllegalArgumentException(
  ...
  //      throw new IllegalArgumentException(
  //          String.format(
  //              "Invalid Tuple value '%s': at character %d expecting '(' but got EOF", value,
  // idx));
  //    }
  //    if (value.charAt(idx) != '(') {
  //      throw new IllegalArgumentException(
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid tuple value '%s': at character %d expecting EOF or blank, but got
  // \"%s\"",
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid tuple value '%s': at field %d (character %d) expecting ',' or ')', but
  // got EOF",
  //                value, fieldIndex, idx));
  //      }
  //      if (value.charAt(idx) == ')') {
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid tuple value '%s': at field %d (character %d) expecting ',' but got
  // '%c'",
  ...
  //    throw new IllegalArgumentException(
  //        String.format(
  //            "Invalid tuple value '%s': at field %d (character %d) expecting CQL value or ')',
  // got EOF",
  //            value, fieldIndex, idx));
  //  }
  //
  ...
  //      throw new IllegalArgumentException(
  //          String.format(
  //              "Invalid UDT value '%s': at character %d expecting CQL identifier or '}', got
  // EOF",
  //              value, idx));
  //    }
  //
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid UDT value '%s': at character %d expecting EOF or blank, but got
  // \"%s\"",
  //                value, idx, value.substring(idx)));
  //      }
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid UDT value '%s': at field %s (character %d) expecting ':', but got
  // '%c'",
  ...
  //        throw new IllegalArgumentException(
  //            String.format(
  //                "Invalid UDT value '%s': at field %s (character %d) expecting ',' or '}', but
  // got EOF",
  //                value, id, idx));
  //      }
  //      if (value.charAt(idx) == '}') {
  ...
  //    throw new IllegalArgumentException(
  //        String.format(
  //            "Invalid UDT value '%s': at field %s (character %d): expecting CQL identifier or
  // '}', got EOF",
  //            value, id, idx));
  //  }
  //
  ...
  //    // the caller to check, when this method return a primary key kind, whether static is also
  // set.
