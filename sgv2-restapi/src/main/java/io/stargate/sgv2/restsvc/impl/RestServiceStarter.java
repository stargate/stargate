...
public class RestServiceStarter {
  ...
  public void start() throws Exception {
    ...
    final HttpMetricsTagProvider httpMetricsTags = new DefaultHttpMetricsTagProvider();
  ...
  public static void main(String[] args) throws Exception {
    cli(args, RestServiceStarter.class);
  }
  ...
  protected static void cli(String[] args, Class<? extends RestServiceStarter> starterClass) {
    SingleCommand<? extends RestServiceStarter> parser = SingleCommand.singleCommand(starterClass);
    try {
      ParseResult<? extends RestServiceStarter> result = parser.parseWithResult(args);
