    ...
    while (fields.hasNext()) {
      ...
      while (ops.hasNext()) {
        ...
        if (op == FilterOp.$IN) {
          ...
          Object mapKey = Converters.parse(keyType, entryKey.asText());
          Object mapValue = Converters.parse(valueType, entryValue.asText());
          conditions.add(
              BuiltCondition.of(
          ...
          if (op == FilterOp.$EXISTS) {
            ...
            if (columnType != null) {
              ...
              val = Converters.parse(valueType, value.asText());
            }
