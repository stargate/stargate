...
class FilterExpressionSearchQueryBuilderTest extends AbstractDataStoreTest {
  ...
  class BuildQuery {
    ...
    public void happyPath() {
      ...
      String expected =
          String.format(
              "SELECT WRITETIME(leaf) FROM %s.%s WHERE p0 = 'field' AND leaf = 'field' AND p1 = '' AND text_value = 'value' ALLOW FILTERING",
