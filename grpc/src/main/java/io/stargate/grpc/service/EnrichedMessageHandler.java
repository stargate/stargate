 ...
 */
public abstract class EnrichedMessageHandler<MessageT extends GeneratedMessageV3, PreparedT> {
  ...
  protected EnrichedMessageHandler(
      MessageT message,
  ...
  private CompletionStage<EnrichedResponse> executeQuery() {
  ...
  protected abstract CompletionStage<EnrichedResponseAndTraceId> buildResponse(Result result);
  ...
  protected EnrichedResponse.Builder makeResponseBuilder(Result result) {
    EnrichedResponse.Builder resultBuilder = EnrichedResponse.newBuilder();
  ...
  protected CompletionStage<EnrichedResponse> executeTracingQueryIfNeeded(
      EnrichedResponseAndTraceId responseAndTraceId) {
    EnrichedResponse.Builder responseBuilder = responseAndTraceId.responseBuilder;
  ...
  protected abstract void setSuccess(EnrichedResponse response);
