...
class MetricCollectingServerCallListener<Q> extends SimpleForwardingServerCallListener<Q> {
  ...
  /**
   * Creates a new delegating {@link ServerCall.Listener} that will wrap the given server call
   * listener to collect metrics.
   *
   ...
   * @param responseStatusTiming The consumer used to time the processing duration along with a
   *     response status.
   */
