    ...
    if (columnCount != valuesCount) {
      StatusException statusException =
          Status.FAILED_PRECONDITION
              ...
              .asException();
      LOG.error(getErrorMessage(Status.FAILED_PRECONDITION, statusException), statusException);
    ...
    if (type == null) {
      StatusException statusException =
          Status.INTERNAL
              ...
              .asException();
      LOG.error(getErrorMessage(Status.INTERNAL, statusException), statusException);
      throw statusException;
    }
    return type;
  }
