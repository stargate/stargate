...
public class BaseRestApiTest extends BaseIntegrationTest {
  ...
  /**
   * Used to define common parameters for configuring REST API service instances.
   * If you need to add/override parameters in a subclass, provide a different
   * parametersCustomizer, but make sure that it invokes this method as well.
   *
