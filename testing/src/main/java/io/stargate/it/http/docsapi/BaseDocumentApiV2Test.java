...
public class BaseDocumentApiV2Test extends BaseOsgiIntegrationTest {
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.food.*.price\": {\"$lt\": 600}}&raw=true&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.food.*.price\": {\"$lte\": 600}}&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.electronics.*.price\": {\"$gte\": 600}}&raw=true&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.*.*.price\": {\"$exists\": true}}&raw=true&page-size=10",
            200);
    searchResultStr =
        "["
            + "{\"products\":{\"electronics\":{\"Pixel_3a\":{\"price\":600}}}},"
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.food.*.price\": {\"$lt\": 600}}&fields=[\"name\", \"price\", \"model\"]&raw=true&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.food.*.price\": {\"$lte\": 600}}&fields=[\"price\", \"sku\"]&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.electronics.*.price\": {\"$gte\": 600}}&fields=[\"price\"]&raw=true&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.*.*.price\": {\"$exists\": true}}&fields=[\"price\", \"name\", \"manufacturer\", \"model\", \"sku\"]&raw=true&page-size=10",
            200);
    searchResultStr =
        "["
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.food.*.sku\": {\"$ne\": null}}&page-size=10",
            200);
    ...
    String r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.electronics.*.model\": {\"$in\": [\"11\", \"3a\"]}}&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.*.*.price\": {\"$in\": [600, 900]}}&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.*.*.price\": {\"$in\": [0.99, 0.89]}}&page-size=10",
            200);
    ...
    String r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.electronics.*.model\": {\"$nin\": [\"12\"]}}&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.*.*.price\": {\"$nin\": [600, 900]}}&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.*.*.price\": {\"$nin\": [0.99, 0.89]}}&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.*.*.sku\": {\"$nin\": [null]}}&page-size=10",
            200);
    ...
    String r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.electronics.*.model\": {\"$nin\": [\"11\"], \"$gt\": \"\"}}&page-size=10",
            200);
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"products.electronics.*.model\": {\"$in\": [\"11\", \"3a\"], \"$ne\": \"11\"}}&page-size=10",
            200);
  ...
  public void testInvalidSearch() throws IOException {
    ...
    assertThat(r)
        .isEqualTo(
            "{\"description\":\"Bad request: Search entry for field a was expecting a JSON object as input.\",\"code\":400}");
    ...
    assertThat(r)
        .isEqualTo(
            "{\"description\":\"Bad request: $exists only supports the value `true`\",\"code\":400}");
    ...
    assertThat(r)
        .startsWith(
            "{\"description\":\"Bad request: Invalid operator: exists, valid operators are:");
    ...
    assertThat(r)
        .isEqualTo(
            "{\"description\":\"Bad request: Value entry for field a, operation $in was expecting an array\",\"code\":400}");
    ...
    assertThat(r)
        .contains(
            "{\"description\":\"Bad request: Conditions across multiple fields are not yet supported");
    ...
    assertThat(r)
        .contains(
            "{\"description\":\"Bad request: When selecting `fields`, the field referenced by `where` must be in the selection.\",\"code\":400}");
    ...
    assertThat(r)
        .contains(
            "{\"description\":\"Bad request: Selecting fields is not allowed without `where`\",\"code\":400}");
  }
    ...
    r =
        RestUtils.get(
            ...
            hostWithPort
                + "/v2/namespaces/"
                + keyspace
                + "/collections/collection/cool-search-id?where={\"quiz.nests.q1,q2.options.[0]\": {\"$eq\": \"nest\"}}&raw=true&page-size=10",
            200);
    searchResultStr =
        "["
