...
public class RestApiTest extends BaseOsgiIntegrationTest
{
    ...
    @Before
    public void setup() throws InvalidSyntaxException, ExecutionException, InterruptedException, IOException {
    ...
    public void getKeyspaces() throws IOException {
        String body = RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces", host), HttpStatus.SC_OK);
    ...
    public void getTables() throws IOException {
        ...
        List<String> keyspaces = objectMapper.readValue(body, new TypeReference<List<String>>() { });
        assertThat(keyspaces).containsAnyOf("IndexInfo","batches","paxos","local","peers_v2","peers","peer_events_v2",
                "peer_events","compaction_history","sstable_activity","size_estimates","available_ranges_v2","available_ranges",
                "transferred_ranges_v2","transferred_ranges","view_builds_in_progress","built_views","prepared_statements","repairs");
    }
    ...
    public void getTable() throws IOException {
        ...
        String body = RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s", host, keyspace, tableName), HttpStatus.SC_OK);
    ...
    public void deleteTable() throws IOException {
        ...
        RestUtils.delete(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s", host, keyspace, tableName), HttpStatus.SC_NO_CONTENT);
    }
    ...
    public void updateRow() throws IOException {
        ...
        String body = RestUtils.put(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows/%s", host, keyspace, tableName, rowIdentifier),
        ...
        rowResponse = objectMapper.readValue(getRow(tableName, rowIdentifier), new TypeReference<RowResponse>() { });
        assertThat(rowResponse.getCount()).isEqualTo(1);
        assertThat(rowResponse.getRows().get(0).get("id")).isEqualTo(rowIdentifier);
    ...
    public void getRowSystemLocal() throws IOException {
        String body = RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows/%s", host, "system", "local", "local"), HttpStatus.SC_OK);
    ...
    public void getRowBadRequest() throws IOException {
        RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows/peer", host, "system", "peers"), HttpStatus.SC_BAD_REQUEST);
    }
    ...
    public void getAllRows() throws IOException {
        ...
        String body = RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows?pageSize=2", host, keyspace, tableName),
                HttpStatus.SC_OK);
    ...
    public void getAllRowsNoSize() throws IOException {
        ...
        String body = RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows", host, keyspace, tableName),
                HttpStatus.SC_OK);
    ...
    public void addRow() throws IOException {
        ...
        String body = RestUtils.post(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows", host, keyspace, tableName),
                objectMapper.writeValueAsString(rowAdd), HttpStatus.SC_CREATED);
    ...
    public void query() throws IOException {
        ...
        String body = RestUtils.post(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows/query", host, keyspace, tableName),
                objectMapper.writeValueAsString(query), HttpStatus.SC_OK);
    ...
    public void queryWithPaging() throws IOException {
        ...
        String body = RestUtils.post(authToken, String.format("%s:8082/v1/keyspaces/%s/tables", host, keyspace),
        ...
        body = RestUtils.post(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows/query", host, keyspace, tableName),
                objectMapper.writeValueAsString(query), HttpStatus.SC_OK);
    ...
    public void getColumns() throws IOException {
        ...
        String body = RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/columns", host, keyspace, tableName),
                HttpStatus.SC_OK);

        List<ColumnDefinition> columnDefinitions = objectMapper.readValue(body, new TypeReference<List<ColumnDefinition>>() { });
    ...
    public void getColumn() throws IOException {
        ...
        String body = RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/columns/firstName", host, keyspace, tableName),
                HttpStatus.SC_OK);

        ColumnDefinition columnDefinition = objectMapper.readValue(body, new TypeReference<ColumnDefinition>() { });
    ...
    public void deleteColumn() throws IOException {
        ...
        RestUtils.delete(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/columns/middleName", host, keyspace, tableName),
                HttpStatus.SC_NO_CONTENT);
    }

    @Test
    public void ping() throws IOException {
        assertThat(RestUtils.get(authToken, String.format("%s:8082/", host), HttpStatus.SC_OK)).isEqualTo("It's Alive");
    }

    @Test
    public void health() throws IOException {
        assertThat(RestUtils.get(authToken, String.format("%s:8082/health", host), HttpStatus.SC_OK)).isEqualTo("UP");
    }
    ...
    private void createTable(String tableName) throws IOException {
        ...
        String body = RestUtils.post(authToken, String.format("%s:8082/v1/keyspaces/%s/tables", host, keyspace), objectMapper.writeValueAsString(tableAdd),
                HttpStatus.SC_CREATED);

        SuccessResponse successResponse = objectMapper.readValue(body, new TypeReference<SuccessResponse>() { });
        assertThat(successResponse.getSuccess()).isTrue();
    }

    private String getRow(String tableName, String rowIdentifier) throws IOException {
        return RestUtils.get(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/rows/%s", host, keyspace, tableName, rowIdentifier),
                HttpStatus.SC_OK);
    }
    ...
    private void createColumn(String tableName, ColumnDefinition columnDefinition) throws IOException {
        String body = RestUtils.post(authToken, String.format("%s:8082/v1/keyspaces/%s/tables/%s/columns", host, keyspace, tableName),
