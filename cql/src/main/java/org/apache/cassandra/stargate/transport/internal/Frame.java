...
public class Frame
{
    ...
    {
        private static final int MAX_FRAME_LENGTH = TransportDescriptor.getNativeTransportMaxFrameSize();
        ...
        throws Exception
        {
            ...
            ProtocolVersion version = ProtocolVersion.decode(versionNum, TransportDescriptor.getNativeTransportAllowOlderProtocols());
