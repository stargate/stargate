...
public record Sgv2UDTAddRequest(
    @Schema(required = true, description = "User Defined Type name") @NotEmpty String name,
    @Schema(required = true, description = "User Defined Type fields") @NotEmpty
        List<Sgv2UDT.UDTField> fields,
    @Schema(
            description =
