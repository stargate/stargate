 ...
 * overload with {@link Error}.
 */
@Schema(name = "Error", description = "A description of an error state")
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class RestServiceError {
  ...
  public RestServiceError(String description) {
    this.description = description;
  }

  public RestServiceError(String description, int code) {
    this.description = description;
    this.code = code;
  }

  /** A human-readable description of the error state */
  public RestServiceError description(String description) {
    this.description = description;
    return this;
  }
  ...
  public RestServiceError code(int code) {
    this.code = code;
    return this;
  }

  @Schema(example = "2200", description = "The internal number referencing the error state")
  @JsonProperty("code")
  public int getCode() {
    return code;
  }
  ...
  public RestServiceError internalTxId(String internalTxId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(description, restServiceError.description)
        && Objects.equals(code, restServiceError.code)
        && Objects.equals(internalTxId, restServiceError.internalTxId);
  }
