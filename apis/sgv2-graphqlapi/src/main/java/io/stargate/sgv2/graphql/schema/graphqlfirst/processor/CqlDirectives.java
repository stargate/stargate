...
public class CqlDirectives {
      ...
      newEnum()
          ...
          .value(
              newEnumValueDefinition()
                  .name(CollectionIndexingType.VALUES.name())
                  .description(
          ...
          .value(
              newEnumValueDefinition()
                  .name(CollectionIndexingType.FULL.name())
                  .description(
  ...
  private static final GraphQLEnumType QUERY_CONSISTENCY_ENUM =
      newEnum()
          ...
          .value(Consistency.LOCAL_ONE.name())
          .value(Consistency.LOCAL_QUORUM.name())
          .value(Consistency.ALL.name())
          .value(Consistency.SERIAL.name())
          .value(Consistency.LOCAL_SERIAL.name())
          .build();
      ...
      newDirective()
          ...
          .argument(
              newArgument()
                  ...
                  .defaultValue(Consistency.LOCAL_QUORUM.name())
                  .build())
          .validLocation(FIELD_DEFINITION)
          .build();
  ...
  private static final GraphQLArgument MUTATION_SERIAL_CONSISTENCY_LEVEL_ARGUMENT =
      newArgument()
          ...
          .defaultValue(Consistency.SERIAL.name())
          .build();
