...
public class ClientStateWrapper implements io.stargate.db.ClientState<ClientState>
{
    ...
    {
        return new ClientStateWrapper(org.apache.cassandra.service.ClientState.forExternalCalls(remoteAddress, null));
    }

    public static ClientStateWrapper forExternalCalls(SocketAddress remoteAddress, InetSocketAddress publicAddress)
    {
        return new ClientStateWrapper(org.apache.cassandra.service.ClientState.forExternalCalls(remoteAddress, null), publicAddress);
    }

    public static ClientStateWrapper forExternalCalls(org.apache.cassandra.auth.AuthenticatedUser user, InetSocketAddress remoteAddress, InetSocketAddress publicAddress)
    {
        return new ClientStateWrapper(org.apache.cassandra.service.ClientState.forExternalCalls(user, remoteAddress), publicAddress);
    }
    ...
    {
        wrapped = wrapped.login((org.apache.cassandra.auth.AuthenticatedUser) user.getWrapped()).blockingGet();
        this.user = user;
    }
