...
import static io.stargate.sgv2.docssvc.services.CombinedPagingState.EXHAUSTED_PAGE_STATE;
...
import io.stargate.sgv2.docssvc.rx.RxUtils;
...
public class QueryExecutor {
  ...
  private final StargateBridgeClient bridgeClient;
  private final DocsApiConfiguration config;

  public QueryExecutor(StargateBridgeClient bridgeClient, DocsApiConfiguration configuration) {
  ...
  public Flowable<RawDocument> queryDocs(
    ...
    return queryDocs(1, cql, pageSize, exponentPageSize, pagingState, context);
  }
  ...
  public Flowable<RawDocument> queryDocs(
      ...
      ExecutionContext context) {
    return queryDocs(
        keyDepth, ImmutableList.of(cql), pageSize, exponentPageSize, pagingState, context);
  }
  ...
  public Flowable<RawDocument> queryDocs(
      ...
      ByteBuffer pagingState,
      ExecutionContext context) {
    return queryDocs(1, cqlQueries, pageSize, exponentPageSize, pagingState, context);
  }
  ...
  public Flowable<RawDocument> queryDocs(
    ...
    return execute(cqlQueries, comparator, pageSize, exponentPageSize, pagingStates, context)
  ...
  private Flowable<ResultSet> fetchPage(String query, int pageSize, ByteBuffer pagingState) {
  ...
  public StargateBridgeClient getBridgeClient() {
    return bridgeClient;
  }
