...
public class HeaderBasedAuthenticationMechanism implements HttpAuthenticationMechanism {
    ...
    public Uni<SecurityIdentity> authenticate(RoutingContext context, IdentityProviderManager identityProviderManager) {
        ...
        if (null != headerValue) {
            HeaderAuthenticationRequest request = new HeaderAuthenticationRequest(headerName, headerValue);
    ...
    public HttpCredentialTransport getCredentialTransport() {
        return new HttpCredentialTransport(HttpCredentialTransport.Type.OTHER_HEADER, headerName);
    }
}
