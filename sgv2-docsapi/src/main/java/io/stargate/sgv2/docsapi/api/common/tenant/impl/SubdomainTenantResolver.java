 ...
 * <p>
 * For example, having <code>tenant-id.domain.com</code> will resolve tenant identifier to the <code>tenant-id</code>.
 * In case of top-level domain, <code>domain.com</code> will resolve tenant identifier to the <code>domain</code>.
 */
