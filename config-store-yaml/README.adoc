...
it will throw the `MissingExtensionSettingsException`. This is a `RuntimeException` and it's the caller's responsibility to catch it and handle gracefully or propagate higher in the call stack.
