...
import io.stargate.api.sql.plan.rel.Modification;
...
/** A Calcite rule that converts DML opretions to Cassandra INSERT/DELETE statements. */
public class ModificationRule extends RelRule<RelRule.Config> {

  private static final Config CONFIG =
      Config.EMPTY
          .withDescription(ModificationRule.class.getSimpleName())
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    call.transformTo(Modification.create(modify, input, traitSet));
  }
}
